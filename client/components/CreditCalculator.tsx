              ...
              <tbody>
                {paymentScheduleData.map((row, idx) => (
                  <tr key={idx} style={{ backgroundColor: '#ffffff', color: '#000000' }}>
                    ...
                    <td style={{ border: '1px solid #6d2fce', padding: '14px 0 14px 6px', textAlign: 'left', fontWeight: 'bold', fontSize: '14px', fontFamily: '"Paytone One", sans-serif', minWidth: '123px' }}>
