            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', fontFamily: '"Paytone One", sans-serif' }}>
              <thead>
                <tr style={{ backgroundColor: '#1800ae', color: '#ffffff' }}>
                  <th style={{ border: '2px solid #1800ae', padding: '12px 6px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>PEŞİNAT</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px 6px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>KREDİ TUTARI</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>12AY</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>18AY</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>24AY</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>36AY</th>
                  <th style={{ border: '2px solid #1800ae', padding: '12px', textAlign: 'center', verticalAlign: 'middle', fontWeight: 'bold', fontSize: '23px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '2px', minWidth: '123px', height: '60px', lineHeight: '1.2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>48AY</th>
                </tr>
              </thead>
              <tbody>
