            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', fontFamily: '"Paytone One", sans-serif' }}>
              <thead>
                <tr style={{ backgroundColor: '#1800ae', color: '#ffffff' }}>
                  ...
                  <th style={{ border: '2px solid #1800ae', padding: '14px 6px 14px 0', textAlign: 'right', fontWeight: 'bold', fontSize: '20px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '0.5px', width: '70px' }}>KREDİ TUTARI</th>
              ...
              <tbody>
                {paymentScheduleData.map((row, idx) => (
                  <tr key={idx} style={{ backgroundColor: '#ffffff', color: '#000000' }}>
                    ...
                    <td style={{ border: '1px solid #6d2fce', padding: '14px 6px 14px 0', textAlign: 'right', fontWeight: 'bold', fontSize: '14px', fontFamily: '"Paytone One", sans-serif', width: '70px' }}>
