            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', fontFamily: '"Paytone One", sans-serif' }}>
              <thead>
                <tr style={{ backgroundColor: '#1800ae', color: '#ffffff' }}>
                  ...
                  <th style={{ border: '2px solid #1800ae', padding: '14px 6px 14px 0', textAlign: 'right', fontWeight: 'bold', fontSize: '20px', fontFamily: '"Paytone One", sans-serif', letterSpacing: '0.5px' }}>KREDİ TUTARI</th>
