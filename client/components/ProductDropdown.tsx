...
export default function ProductDropdown() {
  ...
  return (
    <>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="fixed left-0 right-0 bg-white shadow-xl z-40 transition-all duration-300 opacity-100 scale-100 origin-top" style={{ animation: 'dropdownSlideIn 0.3s ease-out', top: '120px', borderTop: '2px solid #1f3a93' }}>
          {/* Dropdown Header */}
